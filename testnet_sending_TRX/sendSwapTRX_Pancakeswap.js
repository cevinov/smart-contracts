...
describe("Read and Write to the Blockchain", function () {
  ...
  const getAmountOut = async function (amountIn = "2") {
  ...
  it("Send a TRX, i.e swap a tokens", async function () {
    ...
    */
    ...
    // Parameters: address tokenA,address tokenB,uint liquidity,uint amountAMin,uint amountBMin,address to,uint deadline
    ...
    // Output: Error: VM Exception while processing transaction: reverted with reason string 'PancakeRouter: INSUFFICIENT_OUTPUT_AMOUNT'
  });
});
